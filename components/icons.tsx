...
/** 라인 아이콘 모음 (24x24, currentColor). 이모지 대신 사용. */
const PATHS: Record<string, ReactNode> = {
  ...
  bowl: (
    <>
      ...
      <path d="M9 7.6c0-1 .6-2 1.4-2M13 7.2c0-1.1.7-1.9 1.6-1.9" />
    </>
  ),
  calendar: (
    <>
  ...
  sparkle: (
    <>
      ...
      <path d="M19 3.5l.6 1.6 1.6.6-1.6.6-.6 1.6-.6-1.6L17 5.7l1.6-.6Z" />
    </>
  ),
  shield: (
    <>
