  ...
  return (
    <LegalLayout title="개인정보처리방침" updated="2026-07-08">
      ...
      <p>
        ...
        ⑤ 서비스 개선을 위한 방문 기록: 유입 경로(referrer·UTM), 방문한 화면과 누른 항목, 마지막으로 머문 화면, 체류 시간, 기기 구분(모바일/데스크톱).
        <strong>쿠키를 사용하지 않으며 IP 주소를 저장하지 않습니다.</strong> 브라우저 탭 단위로 만들어지는 임의의 값으로만 한 번의 방문을 묶으며,
        탭을 닫으면 그 값은 사라지고 다음 방문과 이어지지 않습니다(개인을 식별하지 않습니다). 수집한 방문 기록은 <strong>30일 후 자동 삭제</strong>됩니다.<br />
